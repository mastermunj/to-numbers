...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    ...
    ordinalWordsMapping: [
      ...
      { number: 20, value: 'ሃያኛ' },
      { number: 19, value: 'አስራ ዘጠኝኛ' },
      { number: 18, value: 'አስራ ስምንትኛ' },
      { number: 17, value: 'አስራ ሰባትኛ' },
      { number: 16, value: 'አስራ ስድስትኛ' },
      { number: 15, value: 'አስራ አምስትኛ' },
      { number: 14, value: 'አስራ አራትኛ' },
      { number: 13, value: 'አስራ ሦስትኛ' },
      { number: 12, value: 'አስራ ሁለትኛ' },
      { number: 11, value: 'አስራ አንድኛ' },
