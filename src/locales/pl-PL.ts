...
export default class Locale implements LocaleInterface {
  public config: LocaleConfig = {
    ...
    fractionDenominatorMapping: {
      ...
      3: { singular: 'Tysiączna', plural: 'Tysiączne' },
      4: { singular: 'Dziesięciotysiączna', plural: 'Dziesięciotysiączne' },
      5: { singular: 'Stutysiączna', plural: 'Stutysiączne' },
...
/**
 * ToNumbers class pre-configured for this locale.
 * This is a lightweight version that only bundles this specific locale.
 *
 * @example
 * import { ToWords } from 'to-numbers/pl-PL';
 * const tn = new ToWords();
 * tn.convert(1234);
 */
