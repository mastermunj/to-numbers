...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('پہلا');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('ایک');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['صفر اعشاریہ ایک دسواں', 0.1],
  ['صفر اعشاریہ تین دسویں', 0.3],
  ['صفر اعشاریہ ایک سوواں', 0.01],
  ['صفر اعشاریہ تین سویں', 0.03],
  ['صفر اعشاریہ ایک ہزارواں', 0.001],
  ['صفر اعشاریہ تین ہزاروی', 0.003],
  ['صفر اعشاریہ ایک دس-ہزارواں', 0.0001],
  ['صفر اعشاریہ تین دس-ہزاروی', 0.0003],
  ['صفر اعشاریہ ایک لاکھواں', 0.00001],
  ['صفر اعشاریہ تین لاکھوی', 0.00003],
  ['صفر اعشاریہ ایک دس-لاکھواں', 0.000001],
  ['صفر اعشاریہ تین دس-لاکھوی', 0.000003],
];
