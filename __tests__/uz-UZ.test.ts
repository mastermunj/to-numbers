...
import uzUz, { ToNumbers as LocaleToNumbers } from '../src/locales/uz-UZ';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(uzUz);
  });
...
const testIntegers: [string, number][] = [
  ['Nol', 0],
  ["Bir Yuz O'ttiz Yetti", 137],
  ['Yetti Yuz', 700],
  ['Bir Ming Bir Yuz', 1100],
  ["To'rt Ming Olti Yuz Sakson", 4680],
  ["Oltmish Uch Ming Sakkiz Yuz To'qson Ikki", 63892],
  ["Ikki Million Yetti Yuz Qirq Bir Ming O'ttiz To'rt", 2741034],
  ["To'qqiz Milliard Sakkiz Yuz Yetmish Olti Million Besh Yuz Qirq Uch Ming Ikki Yuz O'n", 9876543210],
];
...
const testFloats: [string, number][] = [
  ['Nol', 0],
  ["Nol Vergul To'rt", 0.4],
  ["O'ttiz Yetti Vergul Olti", 37.6],
];
