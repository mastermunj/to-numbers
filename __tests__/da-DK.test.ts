...
import daDk, { ToNumbers as LocaleToNumbers } from '../src/locales/da-DK';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(daDk);
  });
...
const testIntegers: [string, number][] = [
  ['Nul', 0],
  ['Hundrede Syvogtredive', 137],
  ['Syv Hundrede', 700],
  ['Tusind Hundrede', 1100],
  ['Fire Tusind Seks Hundrede Firs', 4680],
  ['Treogtres Tusind Otte Hundrede Tooghalvfems', 63892],
  ['Seksogfirs Tusind Hundrede', 86100],
  ['Syv Hundrede Tooghalvfems Tusind Fem Hundrede Enogfirs', 792581],
  ['To Million Syv Hundrede Enogfyrre Tusind Fireogtredive', 2741034],
  ['Seksogfirs Million Fire Hundrede Niogtyve Tusind Syv Hundrede Treoghalvtreds', 86429753],
  ['Ni Hundrede Femoghalvfjerds Million Tre Hundrede Ti Tusind Otte Hundrede Fireogtres', 975310864],
  ['Ni Milliard Otte Hundrede Seksoghalvfjerds Million Fem Hundrede Treogfyrre Tusind To Hundrede Ti', 9876543210],
  ['Otteoghalvfems Milliard Syv Hundrede Femogtres Million Fire Hundrede Toogtredive Tusind Hundrede En', 98765432101],
];
...
const testFloats: [string, number][] = [
  ['Nul', 0],
  ['Nul Komma Nul Fire', 0.04],
  ['Nul Komma Nul Fire Seks Otte', 0.0468],
  ['Nul Komma Fire', 0.4],
  ['Nul Komma Ni Hundrede Treoghalvfjerds', 0.973],
  ['Nul Komma Ni Hundrede Nioghalvfems', 0.999],
  ['Syvogtredive Komma Nul Seks', 37.06],
  ['Syvogtredive Komma Nul Seks Otte', 37.068],
  ['Syvogtredive Komma Otteogtres', 37.68],
  ['Syvogtredive Komma Seks Hundrede Treogfirs', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Første');
