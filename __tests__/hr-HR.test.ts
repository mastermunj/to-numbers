...
import hrHr, { ToNumbers as LocaleToNumbers } from '../src/locales/hr-HR';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(hrHr);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Tisuća Sto', 1100],
  ['Dva Tisuće', 2000],
  ['Četiri Tisuće Šeststo Osamdeset', 4680],
  ['Deset Tisuća', 10000],
  ['Šezdeset Tri Tisuća Osamsto Devedeset Dva', 63892],
  ['Sto Tisuća', 100000],
  ['Milijun', 1000000],
  ['Dva Milijuna', 2000000],
  ['Dva Milijuna Sedamsto Četrdeset Jedan Tisuća Trideset Četiri', 2741034],
  ['Milijarda', 1000000000],
  ['Dva Milijarde', 2000000000],
];
...
const testFloats: [string, number][] = [
  ['Nula', 0],
  ['Nula Zarez Nula Četiri', 0.04],
  ['Nula Zarez Četiri', 0.4],
  ['Nula Zarez Šezdeset Tri', 0.63],
  ['Trideset Sedam Zarez Nula Šest', 37.06],
  ['Trideset Sedam Zarez Šezdeset Osam', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Prvi');
...
const testFractionDecimals: [string, number][] = [
  ['Nula Zarez Jedan Desetinka', 0.1],
  ['Nula Zarez Tri Desetinke', 0.3],
  ['Nula Zarez Jedan Stotinka', 0.01],
  ['Nula Zarez Tri Stotinke', 0.03],
  ['Nula Zarez Jedan Tisućinka', 0.001],
  ['Nula Zarez Tri Tisućinke', 0.003],
  ['Nula Zarez Jedan Desetotisućinka', 0.0001],
  ['Nula Zarez Tri Desetotisućinke', 0.0003],
  ['Nula Zarez Jedan Sto-Tisućinka', 0.00001],
  ['Nula Zarez Tri Sto-Tisućinke', 0.00003],
  ['Nula Zarez Jedan Milijuntinka', 0.000001],
  ['Nula Zarez Tri Milijuntinke', 0.000003],
];
