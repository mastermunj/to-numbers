...
import guIn, { ToNumbers as LocaleToNumbers } from '../src/locales/gu-IN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(guIn);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['નવ અબજ સિત્યાસી કરોડ પાંસઠ લાખ ત્રેતાલીસ હજાર બે સો દસ', 9876543210],
  ['અઠ્ઠાણું અબજ છોતેર કરોડ ચોપન લાખ બત્રીસ હજાર એક સો એક', 98765432101],
  ['નવ ખર્વ સિત્યાસી અબજ પાંસઠ કરોડ ત્રેતાલીસ લાખ એકવીસ હજાર બાર', 987654321012],
  ['અઠ્ઠાણું ખર્વ છોતેર અબજ ચોપન કરોડ બત્રીસ લાખ દસ હજાર એક સો તેવીસ', 9876543210123],
  ['નવ નીલ સિત્યાસી ખર્વ પાંસઠ અબજ ત્રેતાલીસ કરોડ એકવીસ લાખ એક હજાર બે સો ચોત્રીસ', 98765432101234],
];
...
const testFloats: [string, number][] = [
  ['શૂન્ય', 0],
  ['શૂન્ય દશાંશ શૂન્ય ચાર', 0.04],
  ['શૂન્ય દશાંશ શૂન્ય ચાર છ આઠ', 0.0468],
  ['શૂન્ય દશાંશ ચાર', 0.4],
  ['શૂન્ય દશાંશ ત્રેસઠ', 0.63],
  ['શૂન્ય દશાંશ નવ સો તોતેર', 0.973],
  ['શૂન્ય દશાંશ નવ સો નવ્વાણું', 0.999],
  ['સાડત્રીસ દશાંશ શૂન્ય છ', 37.06],
  ['સાડત્રીસ દશાંશ શૂન્ય છ આઠ', 37.068],
  ['સાડત્રીસ દશાંશ અડસઠ', 37.68],
  ['સાડત્રીસ દશાંશ છ સો ત્યાસી', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('પહેલું');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('એક');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['શૂન્ય દશાંશ એક દશાંશ', 0.1],
  ['શૂન્ય દશાંશ એક શતાંશ', 0.01],
  ['શૂન્ય દશાંશ એક સહસ્રાંશ', 0.001],
  ['શૂન્ય દશાંશ એક દશ-સહસ્રાંશ', 0.0001],
  ['શૂન્ય દશાંશ એક શત-સહસ્રાંશ', 0.00001],
  ['શૂન્ય દશાંશ એક દશ-લક્ષાંશ', 0.000001],
];
