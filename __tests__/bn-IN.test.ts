...
import bnIn, { ToNumbers as LocaleToNumbers } from '../src/locales/bn-IN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(bnIn);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['নয় আরব সাতাশি কোটি পঁয়ষট্টি লাখ তেতাল্লিশ হাজার দুই শত দশ', 9876543210],
  ['আটানব্বই আরব ছিয়াত্তর কোটি চুয়ান্ন লাখ বত্রিশ হাজার এক শত এক', 98765432101],
  ['নয় খরব সাতাশি আরব পঁয়ষট্টি কোটি তেতাল্লিশ লাখ একুশ হাজার বারো', 987654321012],
  ['আটানব্বই খরব ছিয়াত্তর আরব চুয়ান্ন কোটি বত্রিশ লাখ দশ হাজার এক শত তেইশ', 9876543210123],
  ['নয় নীল সাতাশি খরব পঁয়ষট্টি আরব তেতাল্লিশ কোটি একুশ লাখ এক হাজার দুই শত চৌত্রিশ', 98765432101234],
];
...
const testFloats: [string, number][] = [
  ['শূন্য', 0],
  ['শূন্য দশমিক শূন্য চার', 0.04],
  ['শূন্য দশমিক শূন্য চার ছয় আট', 0.0468],
  ['শূন্য দশমিক চার', 0.4],
  ['শূন্য দশমিক তেষট্টি', 0.63],
  ['শূন্য দশমিক নয় শত তিয়াত্তর', 0.973],
  ['শূন্য দশমিক নয় শত নিরানব্বই', 0.999],
  ['সাঁইত্রিশ দশমিক শূন্য ছয়', 37.06],
  ['সাঁইত্রিশ দশমিক শূন্য ছয় আট', 37.068],
  ['সাঁইত্রিশ দশমিক অষ্টষষ্টি', 37.68],
  ['সাঁইত্রিশ দশমিক ছয় শত তিরাশী', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('প্রথম');
