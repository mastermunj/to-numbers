...
import amEt, { ToNumbers as LocaleToNumbers } from '../src/locales/am-ET';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(amEt);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['ሰባት መቶ', 700],
  ['አንድ ሺ መቶ', 1100],
  ['አራት ሺ ስድስት መቶ ሰማንያ', 4680],
  ['ስድሳ ሦስት ሺ ስምንት መቶ ዘጠና ሁለት', 63892],
  ['ሰማንያ ስድስት ሺ መቶ', 86100],
  ['ሰባት መቶ ዘጠና ሁለት ሺ አምስት መቶ ሰማንያ አንድ', 792581],
  ['ሁለት ሚሊዮን ሰባት መቶ አርባ አንድ ሺ ሰላሳ አራት', 2741034],
  ['ሰማንያ ስድስት ሚሊዮን አራት መቶ ሃያ ዘጠኝ ሺ ሰባት መቶ ሃምሳ ሦስት', 86429753],
  ['ዘጠኝ መቶ ሰባ አምስት ሚሊዮን ሦስት መቶ አስር ሺ ስምንት መቶ ስድሳ አራት', 975310864],
  ['አንድ ቢሊዮን', 1000000000],
  ['ዘጠኝ ቢሊዮን ስምንት መቶ ሰባ ስድስት ሚሊዮን አምስት መቶ አርባ ሦስት ሺ ሁለት መቶ አስር', 9876543210],
  ['አስር ቢሊዮን', 10000000000],
  ['መቶ ቢሊዮን', 100000000000],
  ['አንድ ትሪሊዮን', 1000000000000],
];
...
const testFloats: [string, number][] = [
  ['ዜሮ', 0],
  ['ዜሮ ነጥብ ዜሮ አራት', 0.04],
  ['ዜሮ ነጥብ ዜሮ አራት ስድስት ስምንት', 0.0468],
  ['ዜሮ ነጥብ አራት', 0.4],
  ['ዜሮ ነጥብ ስድሳ ሦስት', 0.63],
  ['ዜሮ ነጥብ ዘጠኝ መቶ ሰባ ሦስት', 0.973],
  ['ዜሮ ነጥብ ዘጠኝ መቶ ዘጠና ዘጠኝ', 0.999],
  ['ሰላሳ ሰባት ነጥብ ዜሮ ስድስት', 37.06],
  ['ሰላሳ ሰባት ነጥብ ዜሮ ስድስት ስምንት', 37.068],
  ['ሰላሳ ሰባት ነጥብ ስድሳ ስምንት', 37.68],
  ['ሰላሳ ሰባት ነጥብ ስድስት መቶ ሰማንያ ሦስት', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('አንደኛ');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('አንድ');
    expect(result.value).toBe(1);
