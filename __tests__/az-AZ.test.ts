...
import azAz, { ToNumbers as LocaleToNumbers } from '../src/locales/az-AZ';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(azAz);
  });
...
const testIntegers: [string, number][] = [
  ['Sıfır', 0],
  ['Bir Yüz Otuz Yeddi', 137],
  ['Yeddi Yüz', 700],
  ['Min Yüz', 1100],
  ['Dörd Min Altı Yüz Səksən', 4680],
  ['Altmış Üç Min Səkkiz Yüz Doxsan İki', 63892],
  ['Səksən Altı Min Yüz', 86100],
  ['Yeddi Yüz Doxsan İki Min Beş Yüz Səksən Bir', 792581],
  ['İki Milyon Yeddi Yüz Qırx Bir Min Otuz Dörd', 2741034],
  ['Səksən Altı Milyon Dörd Yüz İyirmi Doqquz Min Yeddi Yüz Əlli Üç', 86429753],
  ['Doqquz Yüz Yetmiş Beş Milyon Üç Yüz On Min Səkkiz Yüz Altmış Dörd', 975310864],
  ['Bir Milyard', 1000000000],
  ['Doqquz Milyard Səkkiz Yüz Yetmiş Altı Milyon Beş Yüz Qırx Üç Min İki Yüz On', 9876543210],
  ['On Milyard', 10000000000],
  ['Yüz Milyard', 100000000000],
  ['Bir Trilyon', 1000000000000],
];
...
const testFloats: [string, number][] = [
  ['Sıfır', 0],
  ['Sıfır Nöqtə Sıfır Dörd', 0.04],
  ['Sıfır Nöqtə Sıfır Dörd Altı Səkkiz', 0.0468],
  ['Sıfır Nöqtə Dörd', 0.4],
  ['Sıfır Nöqtə Altmış Üç', 0.63],
  ['Sıfır Nöqtə Doqquz Yüz Yetmiş Üç', 0.973],
  ['Sıfır Nöqtə Doqquz Yüz Doxsan Doqquz', 0.999],
  ['Otuz Yeddi Nöqtə Sıfır Altı', 37.06],
  ['Otuz Yeddi Nöqtə Sıfır Altı Səkkiz', 37.068],
  ['Otuz Yeddi Nöqtə Altmış Səkkiz', 37.68],
  ['Otuz Yeddi Nöqtə Altı Yüz Səksən Üç', 37.683],
];
