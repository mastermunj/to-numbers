...
import enUs, { ToNumbers as LocaleToNumbers, toNumbers as localeToNumbers } from '../src/locales/en-US';
...
describe('Test Locale', () => {
  ...
  test(`Per-locale toNumbers helper: ${localeCode}`, () => {
    expect(localeToNumbers('One Hundred Twenty Three')).toBe(123);
  });
