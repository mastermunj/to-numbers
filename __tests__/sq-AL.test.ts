...
import sqAl, { ToNumbers as LocaleToNumbers } from '../src/locales/sq-AL';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(sqAl);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Tetëdhjetë', 80],
  ['Nëntëdhjetë', 90],
  ['Nëntëdhjetë Nëntë', 99],
  ['Njëqind', 100],
  ['Njëqind Tridhjetë Shtatë', 137],
  ['Dyqind', 200],
  ['Treqind', 300],
  ['Katërqind', 400],
  ['Pesëqind', 500],
  ...
  ['Nëntëqind', 900],
  ['Një Mijë', 1000],
  ['Një Mijë Njëqind', 1100],
  ['Dy Mijë', 2000],
  ['Tre Mijë', 3000],
  ['Katër Mijë', 4000],
  ['Pesë Mijë', 5000],
  ['Katër Mijë Gjashtëqind Tetëdhjetë', 4680],
  ['Dhjetë Mijë', 10000],
  ['Gjashtëdhjetë Tre Mijë Tetëqind Nëntëdhjetë Dy', 63892],
  ['Njëqind Mijë', 100000],
  ['Një Milion', 1000000],
  ['Dy Milion', 2000000],
  ['Pesë Milion', 5000000],
  ['Dy Milion Shtatëqind Dyzet Një Mijë Tridhjetë Katër', 2741034],
  ['Një Miliard', 1000000000],
  ['Dy Miliard', 2000000000],
  ['Pesë Miliard', 5000000000],
];
...
const testFloats: [string, number][] = [
  ['Zero', 0],
  ['Zero Presje Zero Katër', 0.04],
  ['Zero Presje Katër', 0.4],
  ['Zero Presje Gjashtëdhjetë Tre', 0.63],
  ['Tridhjetë Shtatë Presje Zero Gjashtë', 37.06],
  ['Tridhjetë Shtatë Presje Gjashtëdhjetë Tetë', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('I Parë');
