...
import kaGe, { ToNumbers as LocaleToNumbers } from '../src/locales/ka-GE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(kaGe);
  });
...
const testIntegers: [string, number][] = [
  ['ნული', 0],
  ['ერთი ასი ოცდაათი შვიდი', 137],
  ['შვიდასი', 700],
  ['ერთი ათასი ასი', 1100],
  ['ოთხი ათასი ექვსი ასი ოთხმოცი', 4680],
  ['სამოცი სამი ათასი რვა ასი ოთხმოცდაათი ორი', 63892],
  ['ოთხმოცი ექვსი ათასი ასი', 86100],
  ['შვიდი ასი ოთხმოცდაათი ორი ათასი ხუთი ასი ოთხმოცი ერთი', 792581],
  ['ორი მილიონი შვიდი ასი ორმოცი ერთი ათასი ოცდაათი ოთხი', 2741034],
  ['ოთხმოცი ექვსი მილიონი ოთხი ასი ოცი ცხრა ათასი შვიდი ასი ორმოცდაათი სამი', 86429753],
  ['ცხრა ასი სამოცდაათი ხუთი მილიონი სამი ასი ათი ათასი რვა ასი სამოცი ოთხი', 975310864],
  ['ერთი მილიარდი', 1000000000],
  ['ცხრა მილიარდი რვა ასი სამოცდაათი ექვსი მილიონი ხუთი ასი ორმოცი სამი ათასი ორი ასი ათი', 9876543210],
  ['ათი მილიარდი', 10000000000],
  ['ასი მილიარდი', 100000000000],
  ['ერთი ტრილიონი', 1000000000000],
];
...
const testFloats: [string, number][] = [
  ['ნული', 0],
  ['ნული მძიმე ნული ოთხი', 0.04],
  ['ნული მძიმე ნული ოთხი ექვსი რვა', 0.0468],
  ['ნული მძიმე ოთხი', 0.4],
  ['ნული მძიმე სამოცი სამი', 0.63],
  ['ნული მძიმე ცხრა ასი სამოცდაათი სამი', 0.973],
  ['ნული მძიმე ცხრა ასი ოთხმოცდაათი ცხრა', 0.999],
  ['ოცდაათი შვიდი მძიმე ნული ექვსი', 37.06],
  ['ოცდაათი შვიდი მძიმე ნული ექვსი რვა', 37.068],
  ['ოცდაათი შვიდი მძიმე სამოცი რვა', 37.68],
  ['ოცდაათი შვიდი მძიმე ექვსი ასი ოთხმოცი სამი', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('პირველი');
