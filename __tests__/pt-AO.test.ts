...
import ptAo, { ToNumbers as LocaleToNumbers } from '../src/locales/pt-AO';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(ptAo);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Setecentos', 700],
  ['Mil E Cem', 1100],
  ['Quatro Mil E Seiscentos E Oitenta', 4680],
  ['Sessenta E Três Mil E Oitocentos E Noventa E Dois', 63892],
  ['Dois Milhões E Setecentos E Quarenta E Um Mil E Trinta E Quatro', 2741034],
  [
    'Nove Mil Milhões E Oitocentos E Setenta E Seis Milhões E Quinhentos E Quarenta E Três Mil E Duzentos E Dez',
    9876543210,
  ],
];
...
const testFloats: [string, number][] = [
  ...
  ['Trinta E Sete Vírgula Seis', 37.6],
];
