...
import idId, { ToNumbers as LocaleToNumbers } from '../src/locales/id-ID';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(idId);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Dua Ribu', 2000],
  ['Empat Ribu Enam Ratus Delapan Puluh', 4680],
  ['Sepuluh Ribu', 10000],
  ['Sebelas Ribu', 11000],
  ['Dua Puluh Satu Ribu', 21000],
  ['Enam Puluh Tiga Ribu Delapan Ratus Sembilan Puluh Dua', 63892],
  ['Delapan Puluh Enam Ribu Seratus', 86100],
  ['Seratus Ribu', 100000],
  ['Seratus Dua Puluh Tiga Ribu Empat Ratus Lima Puluh Enam', 123456],
  ['Tujuh Ratus Sembilan Puluh Dua Ribu Lima Ratus Delapan Puluh Satu', 792581],
  ['Satu Juta', 1000000],
  ['Dua Juta', 2000000],
  ['Dua Juta Tujuh Ratus Empat Puluh Satu Ribu Tiga Puluh Empat', 2741034],
  ['Sepuluh Juta', 10000000],
  ['Delapan Puluh Enam Juta Empat Ratus Dua Puluh Sembilan Ribu Tujuh Ratus Lima Puluh Tiga', 86429753],
  ['Seratus Juta', 100000000],
  ['Sembilan Ratus Tujuh Puluh Lima Juta Tiga Ratus Sepuluh Ribu Delapan Ratus Enam Puluh Empat', 975310864],
...
const testFloats: [string, number][] = [
  ['Nol', 0],
  ['Nol Koma Nol Empat', 0.04],
  ['Nol Koma Nol Empat Enam Delapan', 0.0468],
  ['Nol Koma Empat', 0.4],
  ['Nol Koma Enam Puluh Tiga', 0.63],
  ['Nol Koma Sembilan Ratus Tujuh Puluh Tiga', 0.973],
  ['Nol Koma Sembilan Ratus Sembilan Puluh Sembilan', 0.999],
  ['Tiga Puluh Tujuh Koma Nol Enam', 37.06],
  ['Tiga Puluh Tujuh Koma Nol Enam Delapan', 37.068],
  ['Tiga Puluh Tujuh Koma Enam Puluh Delapan', 37.68],
  ['Tiga Puluh Tujuh Koma Enam Ratus Delapan Puluh Tiga', 37.683],
];
...
const testFractionDecimals: [string, number][] = [
  ['Nol Koma Satu Persepuluh', 0.1],
  ['Nol Koma Satu Perseratus', 0.01],
  ['Nol Koma Satu Perseribu', 0.001],
  ['Nol Koma Satu Persepuluh Ribu', 0.0001],
  ['Nol Koma Satu Perseratus Ribu', 0.00001],
  ['Nol Koma Satu Persejuta', 0.000001],
];
