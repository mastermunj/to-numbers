...
import thTh, { ToNumbers as LocaleToNumbers } from '../src/locales/th-TH';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(thTh);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['สี่พันหกร้อยแปดสิบ', 4680],
  ['หนึ่งหมื่น', 10000],
  ['หกหมื่นสามพันแปดร้อยเก้าสิบสอง', 63892],
  ['หนึ่งแสน', 100000],
  ['เจ็ดแสนเก้าหมื่นสองพันห้าร้อยแปดสิบหนึ่ง', 792581],
  ['หนึ่งล้าน', 1000000],
  ['สองล้านเจ็ดแสนสี่หมื่นหนึ่งพันสามสิบสี่', 2741034],
  ['แปดสิบหกล้านสี่แสนสองหมื่นเก้าพันเจ็ดร้อยห้าสิบสาม', 86429753],
  ['หนึ่งพันล้าน', 1000000000],
];
...
const testFloats: [string, number][] = [
  ['ศูนย์', 0],
  ['ศูนย์จุดสี่', 0.4],
  ['ศูนย์จุดศูนย์สี่', 0.04],
  ['ศูนย์จุดหกสิบสาม', 0.63],
  ['ศูนย์จุดเก้าร้อยเจ็ดสิบสาม', 0.973],
  ['ศูนย์จุดเก้าร้อยเก้าสิบเก้า', 0.999],
  ['สามสิบเจ็ดจุดศูนย์หก', 37.06],
  ['สามสิบเจ็ดจุดหกสิบแปด', 37.68],
  ['สามสิบเจ็ดจุดหกร้อยแปดสิบสาม', 37.683],
];
