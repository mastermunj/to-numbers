...
import enBd, { ToNumbers as LocaleToNumbers } from '../src/locales/en-BD';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(enBd);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Nine Kharab Eighty Seven Arab Sixty Five Crore Forty Three Lakh Twenty One Thousand Twelve', 987654321012],
];
