...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('पहिला');
...
const testFractionDecimals: [string, number][] = [
  ['शून्य पूर्णांक एक दशांश', 0.1],
  ['शून्य पूर्णांक एक शतांश', 0.01],
  ['शून्य पूर्णांक एक सहस्रांश', 0.001],
  ['शून्य पूर्णांक एक दश-सहस्रांश', 0.0001],
  ['शून्य पूर्णांक एक शत-सहस्रांश', 0.00001],
  ['शून्य पूर्णांक एक दशलक्षांश', 0.000001],
];
