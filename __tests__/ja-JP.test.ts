...
import jaJp, { ToNumbers as LocaleToNumbers } from '../src/locales/ja-JP';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(jaJp);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['千 百', 1100],
  ['四 千 六 百 八十', 4680],
  ['六 万 三 千 八 百 九十 二', 63892],
  ['八 万 六 千 百', 86100],
  ['七 十万 九 万 二 千 五 百 八十 一', 792581],
  ['二 百万 七 十万 四 万 千 三十 四', 2741034],
  ['八 千万 六 百万 四 十万 二 万 九 千 七 百 五十 三', 86429753],
  ['九 億 七 千万 五 百万 三 十万 万 八 百 六十 四', 975310864],
  ['十億', 1000000000],
  ['九 十億 八 億 七 千万 六 百万 五 十万 四 万 三 千 二 百 十', 9876543210],
  ['百億', 10000000000],
  ['千億', 100000000000],
  ['兆', 1000000000000],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('一番目');
