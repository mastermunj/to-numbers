...
import svSe, { ToNumbers as LocaleToNumbers } from '../src/locales/sv-SE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(svSe);
  });
...
const testIntegers: [string, number][] = [
  ['Noll', 0],
  ['Hundra Trettiosju', 137],
  ['Sju Hundra', 700],
  ['Tusen Hundra', 1100],
  ['Fyra Tusen Sex Hundra Åttio', 4680],
  ['Sextiotre Tusen Åtta Hundra Nittiotvå', 63892],
  ['Åttiosex Tusen Hundra', 86100],
  ['Sju Hundra Nittiotvå Tusen Fem Hundra Åttioett', 792581],
  ['Två Miljon Sju Hundra Fyrtioett Tusen Trettiofyra', 2741034],
  ['Åttiosex Miljon Fyra Hundra Tjugonio Tusen Sju Hundra Femtiotre', 86429753],
  ['Nio Hundra Sjuttiofem Miljon Tre Hundra Tio Tusen Åtta Hundra Sextiofyra', 975310864],
  ['Nio Miljard Åtta Hundra Sjuttiosex Miljon Fem Hundra Fyrtiotre Tusen Två Hundra Tio', 9876543210],
  ['Nittioåtta Miljard Sju Hundra Sextiofem Miljon Fyra Hundra Trettiotvå Tusen Hundra Ett', 98765432101],
  ['Nio Hundra Åttiosju Miljard Sex Hundra Femtiofyra Miljon Tre Hundra Tjugoett Tusen Tolv', 987654321012],
];
...
const testFloats: [string, number][] = [
  ['Noll', 0],
  ['Noll Komma Noll Fyra', 0.04],
  ['Noll Komma Noll Fyra Sex Åtta', 0.0468],
  ['Noll Komma Fyra', 0.4],
  ['Noll Komma Nio Hundra Sjuttiotre', 0.973],
  ['Noll Komma Nio Hundra Nittionio', 0.999],
  ['Trettiosju Komma Noll Sex', 37.06],
  ['Trettiosju Komma Noll Sex Åtta', 37.068],
  ['Trettiosju Komma Sextioåtta', 37.68],
  ['Trettiosju Komma Sex Hundra Åttiotre', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Första');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Ett');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['Noll Komma Ett Tiondel', 0.1],
  ['Noll Komma Tre Tiondelar', 0.3],
  ['Noll Komma Ett Hundradel', 0.01],
  ['Noll Komma Tre Hundradedelar', 0.03],
  ['Noll Komma Ett Tusendel', 0.001],
  ['Noll Komma Tre Tusendelar', 0.003],
  ['Noll Komma Ett Tiotusendel', 0.0001],
  ['Noll Komma Tre Tiotunsendelar', 0.0003],
  ['Noll Komma Ett Hundratusendel', 0.00001],
  ['Noll Komma Tre Hundratusendelar', 0.00003],
  ['Noll Komma Ett Milliondel', 0.000001],
  ['Noll Komma Tre Miljondelar', 0.000003],
];
