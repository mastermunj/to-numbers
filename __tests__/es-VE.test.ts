...
import esVe, { ToNumbers as LocaleToNumbers } from '../src/locales/es-VE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(esVe);
  });
...
const testFloats: [string, number][] = [
  ['Cero', 0],
  ['Cero Coma Cero Cuatro', 0.04],
  ['Cero Coma Cero Cuatro Seis Ocho', 0.0468],
  ['Cero Coma Cuatro', 0.4],
  ['Cero Coma Sesenta Y Tres', 0.63],
  ['Cero Coma Novecientos Setenta Y Tres', 0.973],
  ['Cero Coma Novecientos Noventa Y Nueve', 0.999],
  ['Treinta Y Siete Coma Cero Seis', 37.06],
  ['Treinta Y Siete Coma Cero Seis Ocho', 37.068],
  ['Treinta Y Siete Coma Sesenta Y Ocho', 37.68],
  ['Treinta Y Siete Coma Seiscientos Ochenta Y Tres', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Primero');
...
const testFractionDecimals: [string, number][] = [
  ['Cero Coma Uno Décimo', 0.1],
  ['Cero Coma Tres Décimos', 0.3],
  ['Cero Coma Uno Centésimo', 0.01],
  ['Cero Coma Tres Centésimos', 0.03],
  ['Cero Coma Uno Milésimo', 0.001],
  ['Cero Coma Tres Milésimos', 0.003],
  ['Cero Coma Uno Diezmilésimo', 0.0001],
  ['Cero Coma Tres Diezmilésimos', 0.0003],
  ['Cero Coma Uno Cienmilésimo', 0.00001],
  ['Cero Coma Tres Cienmilésimos', 0.00003],
  ['Cero Coma Uno Millonésimo', 0.000001],
  ['Cero Coma Tres Millonésimos', 0.000003],
];
