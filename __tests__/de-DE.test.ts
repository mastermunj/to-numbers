...
import deDe, { ToNumbers as LocaleToNumbers } from '../src/locales/de-DE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(deDe);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Neunundneunzig', 99],
  ['Hundert', 100],
  ['Hundert Siebenunddreißig', 137],
  ['Zwei Hundert', 200],
  ['Sieben Hundert', 700],
  ['Tausend', 1000],
  ['Tausend Hundert', 1100],
  ['Vier Tausend Sechs Hundert Achtzig', 4680],
  ['Dreiundsechzig Tausend Acht Hundert Zweiundneunzig', 63892],
  ['Sechsundachtzig Tausend Hundert', 86100],
  ['Sieben Hundert Zweiundneunzig Tausend Fünf Hundert Einundachtzig', 792581],
  ['Eins Million', 1000000],
  ['Zwei Million', 2000000],
  ['Zwei Million Sieben Hundert Einundvierzig Tausend Vierunddreißig', 2741034],
  ['Sechsundachtzig Million Vier Hundert Neunundzwanzig Tausend Sieben Hundert Dreiundfünfzig', 86429753],
  ['Neun Hundert Fünfundsiebzig Million Drei Hundert Zehn Tausend Acht Hundert Vierundsechzig', 975310864],
  ['Eins Milliarde', 1000000000],
];
...
const testFloats: [string, number][] = [
  ['Null', 0],
  ['Null Komma Null Vier', 0.04],
  ['Null Komma Null Vier Sechs Acht', 0.0468],
  ['Null Komma Vier', 0.4],
  ['Null Komma Neun Hundert Dreiundsiebzig', 0.973],
  ['Null Komma Neun Hundert Neunundneunzig', 0.999],
  ['Siebenunddreißig Komma Null Sechs', 37.06],
  ['Siebenunddreißig Komma Null Sechs Acht', 37.068],
  ['Siebenunddreißig Komma Achtundsechzig', 37.68],
  ['Siebenunddreißig Komma Sechs Hundert Dreiundachtzig', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Erste');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Eins');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['Null Komma Eins Zehntel', 0.1],
  ['Null Komma Eins Hundertstel', 0.01],
  ['Null Komma Eins Tausendstel', 0.001],
  ['Null Komma Eins Zehntausendstel', 0.0001],
  ['Null Komma Eins Hunderttausendstel', 0.00001],
  ['Null Komma Eins Millionstel', 0.000001],
];
