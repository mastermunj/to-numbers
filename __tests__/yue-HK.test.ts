...
import yueHk, { ToNumbers as LocaleToNumbers } from '../src/locales/yue-HK';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(yueHk);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['千 百', 1100],
  ['四 千 六 百 八十', 4680],
  ['六 萬 三 千 八 百 九十 二', 63892],
  ['二 百萬 七 十萬 四 萬 千 三十 四', 2741034],
  ['十億', 1000000000],
];
