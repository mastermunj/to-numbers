...
import csCz, { ToNumbers as LocaleToNumbers } from '../src/locales/cs-CZ';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(csCz);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Čtyři Tisíce', 4000],
  ['Pět Tisíc', 5000],
  ['Čtyři Tisíce Šest Set Osmdesát', 4680],
  ['Deset Tisíc', 10000],
  ['Šedesát Tři Tisíc Osm Set Devadesát Dva', 63892],
  ['Sto Tisíc', 100000],
  ['Milion', 1000000],
  ['Dva Miliony', 2000000],
  ['Pět Milion', 5000000],
  ['Dva Miliony Sedm Set Čtyřicet Jeden Tisíc Třicet Čtyři', 2741034],
  ['Miliarda', 1000000000],
  ['Dva Miliardy', 2000000000],
  ['Pět Miliarda', 5000000000],
];
...
const testFloats: [string, number][] = [
  ['Nula', 0],
  ['Nula Celá Nula Čtyři', 0.04],
  ['Nula Celá Čtyři', 0.4],
  ['Nula Celá Šedesát Tři', 0.63],
  ['Třicet Sedm Celá Nula Šest', 37.06],
  ['Třicet Sedm Celá Šedesát Osm', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('První');
