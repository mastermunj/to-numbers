...
import msSg, { ToNumbers as LocaleToNumbers } from '../src/locales/ms-SG';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(msSg);
  });
...
const testFloats: [string, number][] = [
  ['Kosong', 0],
  ['Kosong Perpuluhan Empat', 0.4],
  ['Tiga Puluh Tujuh Perpuluhan Enam', 37.6],
];
