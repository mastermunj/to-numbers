...
import swKe, { ToNumbers as LocaleToNumbers } from '../src/locales/sw-KE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(swKe);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Themanini Sita Elfu Mia Moja', 86100],
  ['Saba Mia Tisini Mbili Elfu Tano Mia Themanini Moja', 792581],
  ['Mbili Milioni Saba Mia Arobaini Moja Elfu Thelathini Nne', 2741034],
  ['Themanini Sita Milioni Nne Mia Ishirini Tisa Elfu Saba Mia Hamsini Tatu', 86429753],
  ['Tisa Mia Sabini Tano Milioni Tatu Mia Kumi Elfu Nane Mia Sitini Nne', 975310864],
  ['Tisa Bilioni Nane Mia Sabini Sita Milioni Tano Mia Arobaini Tatu Elfu Mbili Mia Kumi', 9876543210],
  ['Tisini Nane Bilioni Saba Mia Sitini Tano Milioni Nne Mia Thelathini Mbili Elfu Moja Mia Moja', 98765432101],
];
...
const testFloats: [string, number][] = [
  ['Sifuri', 0],
  ['Sifuri Nukta Sifuri Nne', 0.04],
  ['Sifuri Nukta Sifuri Nne Sita Nane', 0.0468],
  ['Sifuri Nukta Nne', 0.4],
  ['Sifuri Nukta Sitini Tatu', 0.63],
  ['Sifuri Nukta Tisa Mia Sabini Tatu', 0.973],
  ['Sifuri Nukta Tisa Mia Tisini Tisa', 0.999],
  ['Thelathini Saba Nukta Sifuri Sita', 37.06],
  ['Thelathini Saba Nukta Sifuri Sita Nane', 37.068],
  ['Thelathini Saba Nukta Sitini Nane', 37.68],
  ['Thelathini Saba Nukta Sita Mia Themanini Tatu', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Wa Kwanza');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Moja');
    expect(result.value).toBe(1);
