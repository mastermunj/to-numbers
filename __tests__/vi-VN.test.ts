...
import viVn, { ToNumbers as LocaleToNumbers } from '../src/locales/vi-VN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(viVn);
  });
...
const testIntegers: [string, number][] = [
  ['Không', 0],
  ['Một Trăm Ba Mươi Bảy', 137],
  ['Bảy Trăm', 700],
  ['Một Nghìn Một Trăm', 1100],
  ['Bốn Nghìn Sáu Trăm Tám Mươi', 4680],
  ['Sáu Mươi Ba Nghìn Tám Trăm Chín Mươi Hai', 63892],
  ['Tám Mươi Sáu Nghìn Một Trăm', 86100],
  ['Bảy Trăm Chín Mươi Hai Nghìn Năm Trăm Tám Mươi Một', 792581],
  ['Hai Triệu Bảy Trăm Bốn Mươi Một Nghìn Ba Mươi Bốn', 2741034],
  ['Tám Mươi Sáu Triệu Bốn Trăm Hai Mươi Chín Nghìn Bảy Trăm Năm Mươi Ba', 86429753],
  ['Chín Trăm Bảy Mươi Năm Triệu Ba Trăm Mười Nghìn Tám Trăm Sáu Mươi Bốn', 975310864],
  ['Chín Tỷ Tám Trăm Bảy Mươi Sáu Triệu Năm Trăm Bốn Mươi Ba Nghìn Hai Trăm Mười', 9876543210],
];
...
const testFloats: [string, number][] = [
  ['Không', 0],
  ['Không Phẩy Không Bốn', 0.04],
  ['Không Phẩy Bốn', 0.4],
  ['Không Phẩy Sáu Mươi Ba', 0.63],
  ['Không Phẩy Chín Trăm Bảy Mươi Ba', 0.973],
  ['Ba Mươi Bảy Phẩy Không Sáu', 37.06],
  ['Ba Mươi Bảy Phẩy Sáu Mươi Tám', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Thứ Nhất');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Một');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['Không Phẩy Một Phần Mười', 0.1],
  ['Không Phẩy Một Phần Trăm', 0.01],
  ['Không Phẩy Một Phần Nghìn', 0.001],
  ['Không Phẩy Một Phần Mười Nghìn', 0.0001],
  ['Không Phẩy Một Phần Trăm Nghìn', 0.00001],
  ['Không Phẩy Một Phần Triệu', 0.000001],
];
