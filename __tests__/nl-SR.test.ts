...
import nlSr, { ToNumbers as LocaleToNumbers } from '../src/locales/nl-SR';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(nlSr);
  });
...
const testFloats: [string, number][] = [
  ...
  ['Nul Punt Nul Vier Zes Acht', 0.0468],
  ['Nul Punt Vier', 0.4],
  ['Nul Punt Drieënzestig', 0.63],
  ['Nul Punt Negen Honderd Drieënzeventig', 0.973],
  ['Nul Punt Negen Honderd Negenennegentig', 0.999],
  ['Zevenendertig Punt Nul Zes', 37.06],
  ['Zevenendertig Punt Nul Zes Acht', 37.068],
  ['Zevenendertig Punt Achtenzestig', 37.68],
  ['Zevenendertig Punt Zes Honderd Drieëntachtig', 37.683],
];
