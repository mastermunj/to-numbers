...
import elGr, { ToNumbers as LocaleToNumbers } from '../src/locales/el-GR';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(elGr);
  });
...
const testIntegers: [string, number][] = [
  ['Μηδέν', 0],
  ['Εκατό Τριάντα Επτά', 137],
  ['Επτακόσια', 700],
  ['Χίλια Εκατό', 1100],
  ['Τέσσερα Χιλιάδες Εξακόσια Ογδόντα', 4680],
  ['Εξήντα Τρία Χιλιάδες Οκτακόσια Ενενήντα Δύο', 63892],
  ['Ογδόντα Έξι Χιλιάδες Εκατό', 86100],
  ['Επτακόσια Ενενήντα Δύο Χιλιάδες Πεντακόσια Ογδόντα Ένα', 792581],
  ['Δύο Εκατομμύριο Επτακόσια Σαράντα Ένα Χιλιάδες Τριάντα Τέσσερα', 2741034],
  ['Ογδόντα Έξι Εκατομμύριο Τετρακόσια Είκοσι Εννέα Χιλιάδες Επτακόσια Πενήντα Τρία', 86429753],
  ['Εννιακόσια Εβδομήντα Πέντε Εκατομμύριο Τριακόσια Δέκα Χιλιάδες Οκτακόσια Εξήντα Τέσσερα', 975310864],
];
...
const testFloats: [string, number][] = [
  ['Μηδέν', 0],
  ['Μηδέν Κόμμα Μηδέν Τέσσερα', 0.04],
  ['Μηδέν Κόμμα Τέσσερα', 0.4],
  ['Μηδέν Κόμμα Εξήντα Τρία', 0.63],
  ['Μηδέν Κόμμα Εννιακόσια Εβδομήντα Τρία', 0.973],
  ['Τριάντα Επτά Κόμμα Μηδέν Έξι', 37.06],
  ['Τριάντα Επτά Κόμμα Εξήντα Οκτώ', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Πρώτο');
