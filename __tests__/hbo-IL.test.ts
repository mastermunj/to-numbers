...
import hboIl, { ToNumbers as LocaleToNumbers } from '../src/locales/hbo-IL';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(hboIl);
  });
...
const testIntegers: [string, number][] = [
  ['אפס', 0],
  ['אחת מאה שלשים שבע', 137],
  ['שבע מאה', 700],
  ['אלף מאה', 1100],
  ['ארבע אלף שש מאה שמונים', 4680],
  ['ששים שלש אלף שמנה מאה תשעים שתים', 63892],
  ['שמונים שש אלף מאה', 86100],
  ['שבע מאה תשעים שתים אלף חמש מאה שמונים אחת', 792581],
  ['שתים מיליון שבע מאה ארבעים אחת אלף שלשים ארבע', 2741034],
  ['שמונים שש מיליון ארבע מאה עשרים תשע אלף שבע מאה חמשים שלש', 86429753],
  ['תשע מאה שבעים חמש מיליון שלש מאה עשר אלף שמנה מאה ששים ארבע', 975310864],
  ['מיליארד', 1000000000],
  ['תשע מיליארד שמנה מאה שבעים שש מיליון חמש מאה ארבעים שלש אלף שתים מאה עשר', 9876543210],
  ['עשר מיליארד', 10000000000],
  ['מאה מיליארד', 100000000000],
...
const testFloats: [string, number][] = [
  ['אפס', 0],
  ['אפס נקודה אפס ארבע', 0.04],
  ['אפס נקודה אפס ארבע שש שמנה', 0.0468],
  ['אפס נקודה ארבע', 0.4],
  ['אפס נקודה ששים שלש', 0.63],
  ['אפס נקודה תשע מאה שבעים שלש', 0.973],
  ['אפס נקודה תשע מאה תשעים תשע', 0.999],
  ['שלשים שבע נקודה אפס שש', 37.06],
  ['שלשים שבע נקודה אפס שש שמנה', 37.068],
  ['שלשים שבע נקודה ששים שמנה', 37.68],
  ['שלשים שבע נקודה שש מאה שמונים שלש', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('הראשון');
