...
import myMm, { ToNumbers as LocaleToNumbers } from '../src/locales/my-MM';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(myMm);
  });
...
const testIntegers: [string, number][] = [
  ['သုည', 0],
  ['တစ်ရာသုံးဆယ့်ခုနစ်', 137],
  ['ခုနစ်ရာ', 700],
  ['တစ်ထောင်တစ်ရာ', 1100],
  ['လေးထောင်ခြောက်ရာရှစ်ဆယ်', 4680],
  ['ခြောက်သောင်းသုံးထောင်ရှစ်ရာကိုးဆယ့်နှစ်', 63892],
  ['နှစ်သန်းခုနစ်သိန်းလေးသောင်းတစ်ထောင်သုံးဆယ့်လေး', 2741034],
  ['ကိုးဘီလီယံရှစ်ရာခုနစ်ဆယ့်ခြောက်သန်းငါးသိန်းလေးသောင်းသုံးထောင်နှစ်ရာတစ်ဆယ်', 9876543210],
];
