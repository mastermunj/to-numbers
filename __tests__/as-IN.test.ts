...
import asIn, { ToNumbers as LocaleToNumbers } from '../src/locales/as-IN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(asIn);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['সাত এশ', 700],
  ['এক হাজাৰ এশ', 1100],
  ['চাৰি হাজাৰ ছয় এশ আশী', 4680],
  ['তেষষ্ঠি হাজাৰ আঠ এশ বিয়ান্নব্বৈ', 63892],
  ['বিছ লাখ', 2000000],
  ['নব্বৈ কোটি', 900000000],
];
...
const testFractionDecimals: [string, number][] = [
  ...
  ['শূন্য দশমিক এক সহস্ৰাংশ', 0.001],
  ['শূন্য দশমিক এক দহ-সহস্ৰাংশ', 0.0001],
  ['শূন্য দশমিক এক শত-সহস্ৰাংশ', 0.00001],
  ['শূন্য দশমিক এক দহ-লাখাংশ', 0.000001],
];
