...
import heIl, { ToNumbers as LocaleToNumbers } from '../src/locales/he-IL';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(heIl);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['תשעים ו תשע', 99],
  ['מאה', 100],
  ['אחת מאה ו שלושים ו שבע', 137],
  ['מאתיים', 200],
  ['שלוש מאה', 300],
  ['חמש מאה', 500],
  ['שבע מאה', 700],
  ['תשע מאה ו תשעים ו תשע', 999],
  ['אלף', 1000],
  ['אלף ו אחת', 1001],
  ['אלף ו שתיים מאה ו שלושים ו ארבע', 1234],
  ['אלפיים', 2000],
  ['ארבע אלף ו שש מאה ו שמונים', 4680],
  ['עשר אלף', 10000],
  ['שישים ו שלוש אלף ו שמונה מאה ו תשעים ו שתיים', 63892],
  ['מאה אלף', 100000],
  ['שבע מאה ו תשעים ו שתיים אלף ו חמש מאה ו שמונים ו אחת', 792581],
  ['מיליון', 1000000],
  ['שתיים מיליון ו שבע מאה ו ארבעים ו אחת אלף ו שלושים ו ארבע', 2741034],
  ['שמונים ו שש מיליון ו ארבע מאה ו עשרים ו תשע אלף ו שבע מאה ו חמישים ו שלוש', 86429753],
  ['מיליארד', 1000000000],
];
...
const testFloats: [string, number][] = [
  ...
  ['אפס נקודה שישים ו שלוש', 0.63],
  ['אפס נקודה תשע מאה ו שבעים ו שלוש', 0.973],
  ['אפס נקודה תשע מאה ו תשעים ו תשע', 0.999],
  ['שלושים ו שבע נקודה אפס שש', 37.06],
  ['שלושים ו שבע נקודה שישים ו שמונה', 37.68],
  ['שלושים ו שבע נקודה שש מאה ו שמונים ו שלוש', 37.683],
];
