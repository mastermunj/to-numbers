...
import huHu, { ToNumbers as LocaleToNumbers } from '../src/locales/hu-HU';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(huHu);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Kettő Ezer', 2000],
  ['Három Ezer', 3000],
  ['Négy Ezer Hatszáz Nyolcvan', 4680],
  ['Tíz Ezer', 10000],
  ['Hatvan Három Ezer Nyolcszáz Kilencven Kettő', 63892],
  ['Száz Ezer', 100000],
  ['Egy Millió', 1000000],
  ['Kettő Millió', 2000000],
  ['Kettő Millió Hétszáz Negyven Egy Ezer Harminc Négy', 2741034],
  ['Egy Milliárd', 1000000000],
  ['Kettő Milliárd', 2000000000],
];
...
const testFloats: [string, number][] = [
  ['Nulla', 0],
  ['Nulla Egész Nulla Négy', 0.04],
  ['Nulla Egész Négy', 0.4],
  ['Nulla Egész Hatvan Három', 0.63],
  ['Harminc Hét Egész Nulla Hat', 37.06],
  ['Harminc Hét Egész Hatvan Nyolc', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Első');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Egy');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['Nulla Egész Egy Tized', 0.1],
  ['Nulla Egész Egy Század', 0.01],
  ['Nulla Egész Egy Ezred', 0.001],
  ['Nulla Egész Egy Tízezred', 0.0001],
  ['Nulla Egész Egy Százezred', 0.00001],
  ['Nulla Egész Egy Milliomod', 0.000001],
];
