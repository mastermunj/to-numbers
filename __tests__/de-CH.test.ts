...
import deCh, { ToNumbers as LocaleToNumbers } from '../src/locales/de-CH';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(deCh);
  });
...
const testFloats: [string, number][] = [
  ['Null', 0],
  ['Null Komma Vier', 0.4],
  ['Siebenundvierzig Komma Acht', 47.8],
];
