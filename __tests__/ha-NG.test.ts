...
import haNg, { ToNumbers as LocaleToNumbers } from '../src/locales/ha-NG';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(haNg);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Tamanin', 80],
  ['Ɗari Ɗaya', 100],
  ['Ɗaya Ɗari Da Talatin Da Bakwai', 137],
  ['Biyu Ɗari', 200],
  ['Bakwai Ɗari', 700],
  ['Ɗaya Dubu', 1000],
  ['Ɗaya Dubu Da Ɗari Ɗaya', 1100],
  ['Huɗu Dubu Da Shida Ɗari Da Tamanin', 4680],
  ['Goma Dubu', 10000],
  ['Ɗari Ɗaya Dubu', 100000],
  ['Ɗaya Miliyan', 1000000],
];
...
const testFloats: [string, number][] = [
  ['Sifili', 0],
  ['Sifili Digo Sifili Huɗu', 0.04],
  ['Sifili Digo Huɗu', 0.4],
  ['Sifili Digo Sittin Da Uku', 0.63],
  ['Talatin Da Bakwai Digo Sifili Shida', 37.06],
  ['Talatin Da Bakwai Digo Sittin Da Takwas', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Na Farko');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Ɗaya');
    expect(result.value).toBe(1);
