...
import slSi, { ToNumbers as LocaleToNumbers } from '../src/locales/sl-SI';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(slSi);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Tisoč Sto', 1100],
  ['Dva Tisoč', 2000],
  ['Štiri Tisoč Šeststo Osemdeset', 4680],
  ['Deset Tisoč', 10000],
  ['Šestdeset Tri Tisoč Osemsto Devetdeset Dva', 63892],
  ['Sto Tisoč', 100000],
  ['Milijon', 1000000],
  ['Dva Milijone', 2000000],
  ['Tri Milijone', 3000000],
  ['Pet Milijon', 5000000],
  ['Dva Milijone Sedemsto Štirideset Ena Tisoč Trideset Štiri', 2741034],
...
const testFloats: [string, number][] = [
  ['Nič', 0],
  ['Nič Vejica Nič Štiri', 0.04],
  ['Nič Vejica Štiri', 0.4],
  ['Nič Vejica Šestdeset Tri', 0.63],
  ['Trideset Sedem Vejica Nič Šest', 37.06],
  ['Trideset Sedem Vejica Šestdeset Osem', 37.68],
];
