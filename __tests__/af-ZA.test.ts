...
import afZa, { ToNumbers as LocaleToNumbers } from '../src/locales/af-ZA';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(afZa);
  });
...
const testIntegers: [string, number][] = [
  ['Nul', 0],
  ['Een Honderd Sewe En Dertig', 137],
  ['Sewe Honderd', 700],
  ['Een Duisend Honderd', 1100],
  ['Vier Duisend Ses Honderd Tagtig', 4680],
  ['Drie En Sestig Duisend Agt Honderd Twee En Negentig', 63892],
  ['Ses En Tagtig Duisend Honderd', 86100],
  ['Sewe Honderd Twee En Negentig Duisend Vyf Honderd Een En Tagtig', 792581],
  ['Twee Miljoen Sewe Honderd Een En Veertig Duisend Vier En Dertig', 2741034],
  ['Ses En Tagtig Miljoen Vier Honderd Nege En Twintig Duisend Sewe Honderd Drie En Vyftig', 86429753],
  ['Nege Honderd Vyf En Sewentig Miljoen Drie Honderd Tien Duisend Agt Honderd Vier En Sestig', 975310864],
];
...
const testFloats: [string, number][] = [
  ['Nul', 0],
  ['Nul Punt Nul Vier', 0.04],
  ['Nul Punt Nul Vier Ses Agt', 0.0468],
  ['Nul Punt Vier', 0.4],
  ['Nul Punt Nege Honderd Drie En Sewentig', 0.973],
  ['Nul Punt Nege Honderd Nege En Negentig', 0.999],
  ['Sewe En Dertig Punt Nul Ses', 37.06],
  ['Sewe En Dertig Punt Nul Ses Agt', 37.068],
  ['Sewe En Dertig Punt Agt En Sestig', 37.68],
  ['Sewe En Dertig Punt Ses Honderd Drie En Tagtig', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Eerste');
