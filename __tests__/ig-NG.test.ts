...
import igNg, { ToNumbers as LocaleToNumbers } from '../src/locales/ig-NG';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(igNg);
  });
...
const testIntegers: [string, number][] = [
  ['Adịghị', 0],
  ['Nnari Na Iri Atọ Na Asaa', 137],
  ['Nnari Asaa', 700],
  ['Puku Na Nnari', 1100],
  ['Puku Anọ Na Nnari Isii Na Iri Asatọ', 4680],
  ['Puku Iri Isii Na Atọ Na Nnari Asatọ Na Iri Eteghiete Na Abụọ', 63892],
  ['Nde Abụọ Na Puku Nnari Asaa Na Iri Anọ Na Otu Na Iri Atọ Na Anọ', 2741034],
  [
    'Ijeri Eteghiete Na Nde Nnari Asatọ Na Iri Asaa Na Isii Na Puku Nnari Ise Na Iri Anọ Na Atọ Na Nnari Abụọ Na Iri',
    9876543210,
  ],
];
...
const testFloats: [string, number][] = [
  ['Adịghị', 0],
  ['Adịghị Ntụpọ Anọ', 0.4],
  ['Iri Atọ Na Asaa Ntụpọ Isii', 37.6],
];
