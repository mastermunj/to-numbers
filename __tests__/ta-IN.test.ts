...
import taIn, { ToNumbers as LocaleToNumbers } from '../src/locales/ta-IN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(taIn);
  });
...
const testIntegers: [string, number][] = [
  ['பூஜ்ஜியம்', 0],
  ['ஒன்று நூறு முப்பத்தி ஏழு', 137],
  ['ஏழு நூறு', 700],
  ['நான்கு ஆயிரம் ஆறு நூறு எண்பது', 4680],
  ['அறுபத்தி மூன்று ஆயிரம் எட்டு நூறு தொண்ணூற்றி இரண்டு', 63892],
  ['ஏழு லட்சம் தொண்ணூற்றி இரண்டு ஆயிரம் ஐந்து நூறு எண்பத்தி ஒன்று', 792581],
  ['இருபத்தி ஏழு லட்சம் நாற்பத்தி ஒன்று ஆயிரம் முப்பத்தி நான்கு', 2741034],
  ['எட்டு கோடி அறுபத்தி நான்கு லட்சம் இருபத்தி ஒன்பது ஆயிரம் ஏழு நூறு ஐம்பத்தி மூன்று', 86429753],
  ['தொண்ணூற்றி ஏழு கோடி ஐம்பத்தி மூன்று லட்சம் பத்து ஆயிரம் எட்டு நூறு அறுபத்தி நான்கு', 975310864],
];
...
const testFloats: [string, number][] = [
  ['பூஜ்ஜியம்', 0],
  ['பூஜ்ஜியம் புள்ளி பூஜ்ஜியம் நான்கு', 0.04],
  ['பூஜ்ஜியம் புள்ளி பூஜ்ஜியம் நான்கு ஆறு எட்டு', 0.0468],
  ['பூஜ்ஜியம் புள்ளி நான்கு', 0.4],
  ['பூஜ்ஜியம் புள்ளி அறுபத்தி மூன்று', 0.63],
  ['பூஜ்ஜியம் புள்ளி ஒன்பது நூறு எழுபத்தி மூன்று', 0.973],
  ['பூஜ்ஜியம் புள்ளி ஒன்பது நூறு தொண்ணூற்றி ஒன்பது', 0.999],
  ['முப்பத்தி ஏழு புள்ளி பூஜ்ஜியம் ஆறு', 37.06],
  ['முப்பத்தி ஏழு புள்ளி பூஜ்ஜியம் ஆறு எட்டு', 37.068],
  ['முப்பத்தி ஏழு புள்ளி அறுபத்தி எட்டு', 37.68],
  ['முப்பத்தி ஏழு புள்ளி ஆறு நூறு எண்பத்தி மூன்று', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('முதல்');
