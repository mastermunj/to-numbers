...
import isIs, { ToNumbers as LocaleToNumbers } from '../src/locales/is-IS';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(isIs);
  });
...
const testIntegers: [string, number][] = [
  ['Núll', 0],
  ['Hundrað Þrjátíu Og Sjö', 137],
  ['Sjö Hundrað', 700],
  ['Þúsund Hundrað', 1100],
  ['Fjórir Þúsund Sex Hundrað Áttatíu', 4680],
  ['Sextíu Og Þrír Þúsund Átta Hundrað Níutíu Og Tveir', 63892],
  ['Áttatíu Og Sex Þúsund Hundrað', 86100],
  ['Sjö Hundrað Níutíu Og Tveir Þúsund Fimm Hundrað Áttatíu Og Einn', 792581],
  ['Tveir Milljón Sjö Hundrað Fjörutíu Og Einn Þúsund Þrjátíu Og Fjórir', 2741034],
  ['Áttatíu Og Sex Milljón Fjórir Hundrað Tuttugu Og Níu Þúsund Sjö Hundrað Fimmtíu Og Þrír', 86429753],
  ['Níu Hundrað Sjötíu Og Fimm Milljón Þrír Hundrað Tíu Þúsund Átta Hundrað Sextíu Og Fjórir', 975310864],
];
...
const testFloats: [string, number][] = [
  ['Núll', 0],
  ['Núll Komma Núll Fjórir', 0.04],
  ['Núll Komma Núll Fjórir Sex Átta', 0.0468],
  ['Núll Komma Fjórir', 0.4],
  ['Núll Komma Níu Hundrað Sjötíu Og Þrír', 0.973],
  ['Núll Komma Níu Hundrað Níutíu Og Níu', 0.999],
  ['Þrjátíu Og Sjö Komma Núll Sex', 37.06],
  ['Þrjátíu Og Sjö Komma Núll Sex Átta', 37.068],
  ['Þrjátíu Og Sjö Komma Sextíu Og Átta', 37.68],
  ['Þrjátíu Og Sjö Komma Sex Hundrað Áttatíu Og Þrír', 37.683],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Fyrsti');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Einn');
    expect(result.value).toBe(1);
