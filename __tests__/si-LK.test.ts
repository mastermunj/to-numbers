...
import siLk, { ToNumbers as LocaleToNumbers } from '../src/locales/si-LK';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(siLk);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['හත සිය', 700],
  ['දාහ සිය', 1100],
  ['හතර දාහ හය සිය අසූ', 4680],
  ['හැට තුන දාහ අට සිය අනූ දෙ', 63892],
  ['දෙ මිලියනය', 2000000],
  ['නවය බිලියනය', 9000000000],
];
