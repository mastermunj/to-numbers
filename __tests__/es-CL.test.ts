...
import esCl, { ToNumbers as LocaleToNumbers } from '../src/locales/es-CL';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(esCl);
  });
...
const testFloats: [string, number][] = [
  ...
  ['Treinta Y Siete Coma Seis', 37.6],
];
