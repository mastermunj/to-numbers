...
import ruRu, { ToNumbers as LocaleToNumbers } from '../src/locales/ru-RU';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(ruRu);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Четыре Тысячи', 4000],
  ['Пять Тысяча', 5000],
  ['Четыре Тысячи Шестьсот Восемьдесят', 4680],
  ['Десять Тысяча', 10000],
  ['Шестьдесят Три Тысяч Восемьсот Девяносто Два', 63892],
  ['Сто Тысяч', 100000],
  ['Миллион', 1000000],
  ['Два Миллиона', 2000000],
  ['Пять Миллион', 5000000],
  ['Два Миллиона Семьсот Сорок Один Тысяч Тридцать Четыре', 2741034],
  ['Миллиард', 1000000000],
  ['Два Миллиарда', 2000000000],
  ['Пять Миллиард', 5000000000],
];
...
const testFloats: [string, number][] = [
  ['Ноль', 0],
  ['Ноль Целых Ноль Четыре', 0.04],
  ['Ноль Целых Четыре', 0.4],
  ['Ноль Целых Шестьдесят Три', 0.63],
  ['Тридцать Семь Целых Ноль Шесть', 37.06],
  ['Тридцать Семь Целых Шестьдесят Восемь', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Первый');
  ...
  test('parse returns isOrdinal undefined for cardinal input', () => {
    const result = toNumbers.parse('Один');
    expect(result.value).toBe(1);
...
const testFractionDecimals: [string, number][] = [
  ['Ноль Целых Один Десятая', 0.1],
  ['Ноль Целых Три Десятых', 0.3],
  ['Ноль Целых Один Сотая', 0.01],
  ['Ноль Целых Три Сотых', 0.03],
  ['Ноль Целых Один Тысячная', 0.001],
  ['Ноль Целых Три Тысячных', 0.003],
  ['Ноль Целых Один Десятитысячная', 0.0001],
  ['Ноль Целых Три Десятитысячных', 0.0003],
  ['Ноль Целых Один Стотысячная', 0.00001],
  ['Ноль Целых Три Стотысячных', 0.00003],
  ['Ноль Целых Один Миллионная', 0.000001],
  ['Ноль Целых Три Миллионных', 0.000003],
];
