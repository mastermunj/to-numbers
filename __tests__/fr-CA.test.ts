...
import frCa, { ToNumbers as LocaleToNumbers } from '../src/locales/fr-CA';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(frCa);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Sept Cents', 700],
  ['Mille Cent', 1100],
  ['Quatre Mille Six Cents Quatre-Vingts', 4680],
  ['Soixante-Trois Mille Huit Cents Quatre-Vingt-Douze', 63892],
...
const testFractionDecimals: [string, number][] = [
  ['Zéro Virgule Un Dixième', 0.1],
  ['Zéro Virgule Trois Dixièmes', 0.3],
  ['Zéro Virgule Un Centième', 0.01],
  ['Zéro Virgule Trois Centièmes', 0.03],
  ['Zéro Virgule Un Millième', 0.001],
  ['Zéro Virgule Trois Millièmes', 0.003],
  ['Zéro Virgule Un Dix-Millième', 0.0001],
  ['Zéro Virgule Trois Dix-Millièmes', 0.0003],
  ['Zéro Virgule Un Cent-Millième', 0.00001],
  ['Zéro Virgule Trois Cent-Millièmes', 0.00003],
  ['Zéro Virgule Un Millionième', 0.000001],
  ['Zéro Virgule Trois Millionièmes', 0.000003],
];
