...
import skSk, { ToNumbers as LocaleToNumbers } from '../src/locales/sk-SK';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(skSk);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Štyri Tisíce', 4000],
  ['Päť Tisíc', 5000],
  ['Štyri Tisíce Šesťsto Osemdesiat', 4680],
  ['Desať Tisíc', 10000],
  ['Šesťdesiat Tri Tisíc Osemsto Deväťdesiat Dva', 63892],
  ['Sto Tisíc', 100000],
  ['Milión', 1000000],
  ['Dva Milióny', 2000000],
  ['Päť Milión', 5000000],
  ['Dva Milióny Sedemsto Štyridsať Jeden Tisíc Tridsať Štyri', 2741034],
  ['Miliarda', 1000000000],
  ['Dva Miliardy', 2000000000],
  ['Päť Miliarda', 5000000000],
];
...
const testFloats: [string, number][] = [
  ['Nula', 0],
  ['Nula Celá Nula Štyri', 0.04],
  ['Nula Celá Štyri', 0.4],
  ['Nula Celá Šesťdesiat Tri', 0.63],
  ['Tridsať Sedem Celá Nula Šesť', 37.06],
  ['Tridsať Sedem Celá Šesťdesiat Osem', 37.68],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('Prvý');
...
const testFractionDecimals: [string, number][] = [
  ['Nula Celá Jeden Desatina', 0.1],
  ['Nula Celá Tri Desatiny', 0.3],
  ['Nula Celá Jeden Stotina', 0.01],
  ['Nula Celá Tri Stotiny', 0.03],
  ['Nula Celá Jeden Tisícina', 0.001],
  ['Nula Celá Tri Tisíciny', 0.003],
  ['Nula Celá Jeden Desaťtisícina', 0.0001],
  ['Nula Celá Tri Desaťtisíciny', 0.0003],
  ['Nula Celá Jeden Stotisícina', 0.00001],
  ['Nula Celá Tri Stotisíciny', 0.00003],
  ['Nula Celá Jeden Miliontina', 0.000001],
  ['Nula Celá Tri Miliontiny', 0.000003],
];
