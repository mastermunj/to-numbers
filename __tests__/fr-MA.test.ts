...
import frMa, { ToNumbers as LocaleToNumbers } from '../src/locales/fr-MA';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(frMa);
  });
...
const testFloats: [string, number][] = [
  ...
  ['Zéro Virgule Soixante-Treize', 0.73],
