...
import kmKh, { ToNumbers as LocaleToNumbers } from '../src/locales/km-KH';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(kmKh);
  });
...
const testIntegers: [string, number][] = [
  ['សូន្យ', 0],
  ['មួយរយសាមសិបប្រាំពីរ', 137],
  ['ប្រាំពីររយ', 700],
  ['មួយពាន់មួយរយ', 1100],
  ['បួនពាន់ប្រាំមួយរយប៉ែតសិប', 4680],
  ['ប្រាំមួយមុឺនបីពាន់ប្រាំបីរយកៅសិបពីរ', 63892],
  ['ពីរលានប្រាំពីរសែនបួនមុឺនមួយពាន់សាមសិបបួន', 2741034],
  ['ប្រាំបួនប៊ីលានប្រាំបីរយចិតសិបប្រាំមួយលានប្រាំសែនបួនមុឺនបីពាន់ពីររយដប់', 9876543210],
];
...
const testFloats: [string, number][] = [
  ['សូន្យ', 0],
  ['សូន្យចុចបួន', 0.4],
  ['សាមសិបប្រាំពីរចុចប្រាំមួយ', 37.6],
];
