...
const testFractionDecimals: [string, number][] = [
  ['Null Komma En Tiendedel', 0.1],
  ['Null Komma Tre Tiendedeler', 0.3],
  ['Null Komma En Hundredel', 0.01],
  ['Null Komma Tre Hundredeler', 0.03],
  ['Null Komma En Tusendel', 0.001],
  ['Null Komma Tre Tusendeler', 0.003],
  ['Null Komma En Titusendel', 0.0001],
  ['Null Komma Tre Titusendeler', 0.0003],
  ['Null Komma En Hundretusendel', 0.00001],
  ['Null Komma Tre Hundretusendeler', 0.00003],
  ['Null Komma En Milliondel', 0.000001],
  ['Null Komma Tre Milliondeler', 0.000003],
];
