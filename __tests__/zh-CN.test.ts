...
import zhCn, { ToNumbers as LocaleToNumbers } from '../src/locales/zh-CN';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(zhCn);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['九 亿 七 千万 五 百万 三 十万 万 八 百 六十 四', 975310864],
  ['十亿', 1000000000],
  ['九 十亿 八 亿 七 千万 六 百万 五 十万 四 万 三 千 二 百 十', 9876543210],
  ['百亿', 10000000000],
  ['千亿', 100000000000],
  ['兆', 1000000000000],
];
...
describe('Test Ordinal Parse Result', () => {
  test('parse returns isOrdinal true for ordinal input', () => {
    const result = toNumbers.parse('第一');
