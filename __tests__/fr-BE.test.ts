...
import frBe, { ToNumbers as LocaleToNumbers } from '../src/locales/fr-BE';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(frBe);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Sept Cents', 700],
  ['Quatre Mille Six Cent Quatre-Vingts', 4680],
...
const testFloats: [string, number][] = [
  ...
  ['Zéro Virgule Neuf Cent Septante-Trois', 0.973],
  ['Zéro Virgule Neuf Cent Nonante-Neuf', 0.999],
