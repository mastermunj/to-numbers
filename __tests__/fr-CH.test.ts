...
import frCh, { ToNumbers as LocaleToNumbers } from '../src/locales/fr-CH';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(frCh);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['Soixante-Trois Mille Huit Cents Nonante-Deux', 63892],
