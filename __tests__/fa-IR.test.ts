...
import faIr, { ToNumbers as LocaleToNumbers } from '../src/locales/fa-IR';
...
describe('Test Locale', () => {
  test(`Locale Class: ${localeCode}`, () => {
    expect(toNumbers.getLocaleClass()).toBe(faIr);
  });
...
const testIntegers: [string, number][] = [
  ...
  ['صد و سی و هفت', 137],
  ['هفتصد', 700],
  ['چهار هزار و ششصد و هشتاد', 4680],
  ['شصت و سه هزار و هشتصد و نود و دو', 63892],
  ['هفتصد و نود و دو هزار و پانصد و هشتاد و یک', 792581],
  ['دو میلیون و هفتصد و چهل و یک هزار و سی و چهار', 2741034],
  ['هشتاد و شش میلیون و چهارصد و بیست و نه هزار و هفتصد و پنجاه و سه', 86429753],
  ['نهصد و هفتاد و پنج میلیون و سیصد و ده هزار و هشتصد و شصت و چهار', 975310864],
  ['نه میلیارد و هشتصد و هفتاد و شش میلیون و پانصد و چهل و سه هزار و دویست و ده', 9876543210],
  ['نود و هشت میلیارد و هفتصد و شصت و پنج میلیون و چهارصد و سی و دو هزار و صد و یک', 98765432101],
  ['نهصد و هشتاد و هفت میلیارد و ششصد و پنجاه و چهار میلیون و سیصد و بیست و یک هزار و دوازده', 987654321012],
];
